  ...
  return (
    <div >
        <div className='flex justify-between py-3 px-6 shadow-lg'>
            ...
            <div ><Menu onClick={() =>{handleToggleHandler()}}  className='cursor-pointer'/></div>
            <Link to="/"><div className='w-20'><img src="https://imgs.search.brave.com/j5mgu_8cgf9zCKXVzmb8j9-c3HxvaE0Zn5MzOepjoSE/rs:fit:500:0:1:0/g:ce/aHR0cHM6Ly9jZG4u/d29ybGR2ZWN0b3Js/b2dvLmNvbS9sb2dv/cy95b3V0dWJlLTIu/c3Zn" alt="youtube-logo" /></div></Link>
        </div>
